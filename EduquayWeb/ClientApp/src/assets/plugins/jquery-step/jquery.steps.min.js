...
! function(a, b) {
    ...
    function h(a, b) {
        ...
        a.triggerHandler("finishing", [b.currentIndex]) && submitSubject(b.currentIndex)? (c.addClass("done").removeClass("error"), a.triggerHandler("finished", [b.currentIndex])) : c.addClass("error")
    }
    ...
    function B(a, b, c, d) {
        if(!isFormValid(c.currentIndex)) return;
        var e = c.currentIndex;
