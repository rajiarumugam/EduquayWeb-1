...
@Component({
  ...
  templateUrl: './mtp-sevice-completed.component.html',
  styleUrls: ['./mtp-sevice-completed.component.css']
})
export class MTPServiceCompletedComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  ngOnInit() {
    ...
    if(mtpTestingArr !== undefined && mtpTestingArr.status.toString() === "true"){
      ...
      this.mtpCompletedArray = mtpTestingArr.data;
    }
