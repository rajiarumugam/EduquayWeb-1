...
@Component({
  selector: 'app-chc-update-cbc-chc',
  templateUrl: './chc-update-cbc-chc.component.html',
  styleUrls: ['./chc-update-cbc-chc.component.css']
})
export class CHCUpdateCBCCHCComponent implements OnInit {
  receivedSampleCount;
  uploadCBCCount = 0;
