...
@Component({
  selector: 'app-chc-sample-shipmentlog-Maldi',
  templateUrl: './chc-sample-shipmentlog-Maldi.component.html',
  styleUrls: ['./chc-sample-shipmentlog-Maldi.component.css']
})
export class ChcSampleShipmentlogMaldiComponent implements OnInit {
...
chcsampleshipmentLogList(chcId){
 ...
 // this.chcshipmentlogRequest = {userId: this.user.id, shipmentFrom: this.user.shipmentFrom };
  let shipmentLog = this.ChcSampleShipmentlogService.getmaldishipmentLog(this.user.chcId)
  .subscribe(response => {
