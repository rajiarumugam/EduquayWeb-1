...
@Component({
  selector: 'app-dc-monthly-reports-component-main',
  templateUrl: './dc-monthly-reports-component-main.component.html',
  styleUrls: ['./dc-monthly-reports-component-main.component.css']
})
export class DCMonthlyReportsMain implements OnInit {
