...
@Component({
  selector: 'app-district-report-list',
  templateUrl: './district-report-list.component.html',
  styleUrls: ['./district-report-list.component.css']
})
export class DistrictreportListComponent implements AfterViewInit, OnDestroy, OnInit {
