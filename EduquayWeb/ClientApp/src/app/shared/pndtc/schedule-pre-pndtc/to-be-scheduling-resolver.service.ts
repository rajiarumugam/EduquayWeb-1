...
export class ToBeSchedulingResolverService implements Resolve<any>{
  ...
  resolve(
    ...
    return this.SchedulePrePndtcService.getschedulingLists(this.SchedulePrePndtcRequest).pipe(
      catchError(error => {
        console.log(error);
