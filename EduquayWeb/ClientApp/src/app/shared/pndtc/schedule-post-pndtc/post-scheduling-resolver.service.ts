...
export class PostSchedulingResolverService implements Resolve<any>{
  ...
  resolve(
    ...
    return this.SchedulePostPndtcService.getschedulingLists(this.SchedulePostPndtcRequest).pipe(
      catchError(error => {
        console.log(error);
