...
@Component({
  selector: 'app-cl-view-report-sample-main',
  templateUrl: './cl-view-report-sample-main.component.html',
  styleUrls: ['./cl-view-report-sample-main.component.css']
})
export class ViewReportCLMainMainComponent implements OnInit {
