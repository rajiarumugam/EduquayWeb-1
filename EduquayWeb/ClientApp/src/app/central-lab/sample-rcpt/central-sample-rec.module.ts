...
import { CentralSampleRecRoutingModule } from './central-sample-rec.routing';
...
@NgModule({
  ...
  declarations: [CentralSampleRcptMainComponent, CentralSampleRcptComponent]
})
export class CentralSampleRecModule { }
