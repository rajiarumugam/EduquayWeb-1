...
@Component({
  selector: 'app-central-update-hplc-received',
  templateUrl: './central-update-hplc-received.component.html',
  styleUrls: ['./central-update-hplc-received.component.css']
})
export class CentralReceivedSampleComponent implements OnInit {
