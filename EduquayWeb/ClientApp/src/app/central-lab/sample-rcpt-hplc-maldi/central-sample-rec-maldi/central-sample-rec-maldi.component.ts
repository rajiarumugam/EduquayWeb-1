...
@Component({
  selector: 'app-central-sample-rec-maldi',
  templateUrl: './central-sample-rec-maldi.component.html',
  styleUrls: ['./central-sample-rec-maldi.component.css']
})
export class CentralSampleRcptMaldiHPLCComponent implements OnInit {
