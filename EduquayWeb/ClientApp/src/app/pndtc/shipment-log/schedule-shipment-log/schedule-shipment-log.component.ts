...
@Component({
  selector: 'app-schedule-shipment-log',
  templateUrl: './schedule-shipment-log.component.html',
  styleUrls: ['./schedule-shipment-log.component.css']
})
export class ScheduleShipmentComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Schedule & Counsel (Pre-PNDT)", "page": "Shipment Log"}));
