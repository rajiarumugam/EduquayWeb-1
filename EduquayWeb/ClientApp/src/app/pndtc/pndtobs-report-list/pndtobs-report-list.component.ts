...
@Component({
  selector: 'app-pndtobs-report-list',
  templateUrl: './pndtobs-report-list.component.html',
  styleUrls: ['./pndtobs-report-list.component.css']
})
export class PNDTOBSreportListComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  anmSubjectProfileList(id,maintab,subtab) {
    if(maintab==7 && subtab==1)
    {
      subtab=4
    }
    else if(maintab==7 && subtab==2)
    {
      subtab=5
    }
    else if(maintab==7 && subtab==3)
    {
      subtab=6
    }
    else
