...
@Component({
  ...
  templateUrl: './cvs-specimen-reports-print.component.html',
  styleUrls: ['./cvs-specimen-reports-print.component.css']
})
export class CVSPosPrintComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  printPdf()
  {
    ...
    {
      setTimeout(() => {
        document.title="TSCOD CVS Genetic Diagnosis Report - "+new Date().getDate()+(Number(new Date().getMonth())+1)+new Date().getFullYear()+"-"+new Date().getHours()+"-"+new Date().getMinutes();
      window.print();
