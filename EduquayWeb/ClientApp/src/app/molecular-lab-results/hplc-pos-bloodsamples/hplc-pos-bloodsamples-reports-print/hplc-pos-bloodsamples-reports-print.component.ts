...
@Component({
  selector: 'app-hplc-pos-bloodsamples-reports-print',
  templateUrl: './hplc-pos-bloodsamples-reports-print.component.html',
  styleUrls: ['./hplc-pos-bloodsamples-reports-print.component.css']
})
export class HPLCPosPrintComponent implements AfterViewInit, OnDestroy, OnInit {
