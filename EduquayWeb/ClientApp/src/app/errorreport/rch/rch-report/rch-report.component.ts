...
@Component({
  ...
  templateUrl: './rch-report.component.html',
  styleUrls: ['./rch-report.component.css']
})
export class RCHReportComponent implements OnInit {
  submitted = false;
  ...
  onSubmit() {
    ...
    clicksearchBarcode()
    {
      ...
      this.errorCorrectionService.getRCHErrorReport(_obj)
      .subscribe(response => {
        console.log(response);
        this.centralPickpackPendingData = response.data;
        this.loaderService.display(false);
