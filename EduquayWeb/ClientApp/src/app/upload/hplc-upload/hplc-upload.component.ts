...
@Component({
  selector: 'app-hplc-upload',
  templateUrl: './hplc-upload.component.html',
  styleUrls: ['./hplc-upload.component.css']
})
export class HPLCUploadComponent implements OnInit {
  ...
  constructor(
    ...
    ngOnInit() {
      ...
      this.DataService.sendData(JSON.stringify({"module": "Upload", "page": "HPLC"}));
