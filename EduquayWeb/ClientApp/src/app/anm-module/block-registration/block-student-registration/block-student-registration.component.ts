...
@Component({
  selector: 'app-block-student-registration',
  templateUrl: './block-student-registration.component.html',
  styleUrls: ['./block-student-registration.component.css']
})
export class BlockStudentRegistrationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Block - REG & SAMPLING", "submodule": "Subject Registration", "page": "Age < 18"}));
