...
@Component({
  selector: 'app-block-sample-collection',
  templateUrl: './block-sample-collection.component.html',
  styleUrls: ['./block-sample-collection.component.css']
})
export class BlockSampleCollectionComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Block - REG & SAMPLING", "page": "Sample Collection"}));
...
onSubmit(chcCollectionForm: NgForm){
  ...
  this.chcsampleCollectionDateTimeRequest = {
    ...
    collectedBy: Number(this.selectedANM),
  };
