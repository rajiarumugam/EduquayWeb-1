...
@Component({
  selector: 'app-update-pregnacy-main',
  templateUrl: './update-pregnacy-main.component.html',
  styleUrls: ['./update-pregnacy-main.component.css']
})
export class UpdatePregnacyMainComponent implements OnInit {
