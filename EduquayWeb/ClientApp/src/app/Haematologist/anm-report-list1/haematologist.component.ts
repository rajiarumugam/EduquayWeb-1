...
@Component({
  selector: 'haematologist-list',
  templateUrl: './haematologist.component.html',
  styleUrls: ['./haematologist-list.component.css']
})
export class HEMreportListComponent1 implements AfterViewInit, OnDestroy, OnInit {
  ...
  getAnmSubjectProfileList(id,maintab,subtab) {
  ...
  custumTabClick(i,j)
  {
      ...
      this.getAnmSubjectProfileList(1,i,j);
  }
  ngOnDestroy(): void {
