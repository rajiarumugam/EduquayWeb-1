...
@Component({
  selector: 'app-view-case-sheet-main',
  templateUrl: './view-case-sheet-main.component.html',
  styleUrls: ['./view-case-sheet-main.component.css']
})
export class ViewCaseSheetMainComponent implements OnInit {
