...
@Component({
  selector: 'app-view-case-sheet',
  templateUrl: './view-case-sheet.component.html',
  styleUrls: ['./view-case-sheet.component.css']
})
export class ViewCaseSheetComponent implements AfterViewInit, OnDestroy, OnInit {
