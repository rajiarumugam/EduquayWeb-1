...
@Component({
  selector: 'app-update-mol-result-main',
  templateUrl: './update-mol-result-main.component.html',
  styleUrls: ['./update-mol-result-main.component.css']
})
export class UpdateMolResultMainComponent implements OnInit {
