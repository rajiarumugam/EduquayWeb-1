...
@Component({
  selector: 'app-view-report-sample-main',
  templateUrl: './view-report-sample-main.component.html',
  styleUrls: ['./view-report-sample-main.component.css']
})
export class ViewReportPathoMainMainComponent implements OnInit {
