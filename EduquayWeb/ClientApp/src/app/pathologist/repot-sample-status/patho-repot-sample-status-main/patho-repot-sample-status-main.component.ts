...
@Component({
  selector: 'app-patho-repot-sample-status-main',
  templateUrl: './patho-repot-sample-status-main.component.html',
  styleUrls: ['./patho-repot-sample-status-main.component.css']
})
export class PathoreportSampleStatusMainComponent implements OnInit {
