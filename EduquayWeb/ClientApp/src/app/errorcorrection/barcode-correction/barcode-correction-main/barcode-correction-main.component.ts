...
@Component({
  selector: 'app-barcode-correction-main',
  templateUrl: './barcode-correction-main.component.html',
  styleUrls: ['./barcode-correction-main.component.css']
})
export class BarcodeCorrectionMainComponent implements OnInit {
