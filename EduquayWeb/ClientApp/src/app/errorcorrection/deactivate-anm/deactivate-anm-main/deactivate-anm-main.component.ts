...
@Component({
  selector: 'app-deactivate-anm-main',
  templateUrl: './deactivate-anm-main.component.html',
  styleUrls: ['./deactivate-anm-main.component.css']
})
export class DeactivateanmMainComponent implements OnInit {
