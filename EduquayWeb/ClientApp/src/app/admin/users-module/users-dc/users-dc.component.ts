...
@Component({
  selector: 'app-users-dc',
  templateUrl: './users-dc.component.html',
  styleUrls: ['./users-dc.component.css']
})
export class UsersAdminDCComponent implements OnInit {
...
selectedChc: string;
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Users", "submodule": "DC"}));
