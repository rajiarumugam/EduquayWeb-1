...
@Component({
  selector: 'app-users-hplc',
  templateUrl: './users-hplc.component.html',
  styleUrls: ['./users-hplc.component.css']
})
export class UsersAdminHPLCComponent implements OnInit {
...
selectedChc: string;
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Users", "submodule": "HPLC"}));
  ...
  ddlUserRole() {
    ...
    let district = this.UsersService.getUserroleListType(5).subscribe(response => {
