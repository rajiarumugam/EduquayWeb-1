...
@Component({
  selector: 'app-users-nhm',
  templateUrl: './users-nhm.component.html',
  styleUrls: ['./users-nhm.component.css']
})
export class UsersAdminNHMComponent implements OnInit {
...
selectedChc: string;
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Users", "submodule": "NHM"}));
  ...
  refreshData()
      {
        this.loaderService.display(true);
        this.UsersService.getUsersList(11).subscribe(response => {
