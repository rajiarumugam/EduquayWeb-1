...
@Component({
  selector: 'app-users-pndt',
  templateUrl: './users-pndt.component.html',
  styleUrls: ['./users-pndt.component.css']
})
export class UsersAdminPNDTComponent implements OnInit {
...
selectedChc: string;
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Users", "submodule": "PNDT"}));
  ...
  refreshData()
      {
        this.loaderService.display(true);
        this.UsersService.getUsersList(12).subscribe(response => {
      ...
      editSubmitpndt(editpndtForm: NgForm){
          ...
          this.mobileNo = editpndtForm.value.mobileNo1;
