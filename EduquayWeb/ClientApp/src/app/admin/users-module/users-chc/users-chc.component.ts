...
@Component({
  selector: 'app-users-chc',
  templateUrl: './users-chc.component.html',
  styleUrls: ['./users-chc.component.css']
})
export class UsersAdminCHCComponent implements OnInit {
...
selectedChc: string;
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Users", "submodule": "CHC"}));
  ...
  ddlUserRole() {
    ...
    let district = this.UsersService.getUserroleListType(4).subscribe(response => {
