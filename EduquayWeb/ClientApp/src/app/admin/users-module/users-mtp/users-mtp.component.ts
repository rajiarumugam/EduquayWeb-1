...
@Component({
  selector: 'app-users-mtp',
  templateUrl: './users-mtp.component.html',
  styleUrls: ['./users-mtp.component.css']
})
export class UsersAdminMTPComponent implements OnInit {
...
selectedChc: string;
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Users", "submodule": "MTP"}));
  ...
  refreshData()
      {
        ...
        this.UsersService.getUsersList(7).subscribe(response => {
