...
@Component({
  selector: 'app-users-pndtc',
  templateUrl: './users-pndtc.component.html',
  styleUrls: ['./users-pndtc.component.css']
})
export class UsersAdminPNDTCComponent implements OnInit {
...
selectedChc: string;
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Users", "submodule": "PNDTC"}));
  ...
  refreshData()
      {
        ...
        this.UsersService.getUsersList(6).subscribe(response => {
      ...
      openEditpndtc(editpndtcDetail, subjectinfo) {
        ...
        this.id = subjectinfo.id;
         ...
         this.email=subjectinfo.email;
          this.editComments= subjectinfo.comments;
