...
@Component({
  selector: 'app-users-anm',
  templateUrl: './users-anm.component.html',
  styleUrls: ['./users-anm.component.css']
})
export class UsersAdminANMComponent implements OnInit {
...
selectedChc: string;
  ...
  ngOnInit() {
    ...
    this.dataservice.sendData(JSON.stringify({"module": "Users", "submodule": "ANM"}));
